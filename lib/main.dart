          ...
          backgroundColor: Color.fromARGB(255, 3, 226, 226) ,     
                ...
                Row(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(
                        "Forgot Password?",
                        style: TextStyle(color: Color(0xFF777B7E)),
                      ),
                    ),
                  ],
                ),
            ...
            Row(
              ...
              children: [
                Padding(
                  ...
                  child: Text("Log in with social media" , style: TextStyle(fontSize:12.5 ,color:Color(0xFF777B7E) ),),
                ),
              ],
            ),
            ...
            Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Text("New User?" , style: TextStyle(color: Color(0xFF777B7E) , fontSize: 12),),
                  SizedBox(width: 4) ,
                  Text("Sign up" , style: TextStyle(color: Colors.blue[900] , fontSize: 14 , decoration: TextDecoration.underline , decorationColor: Colors.blue[900] ,decorationThickness: 2 , decorationStyle: TextDecorationStyle.solid),)
                ],
              ),
            )
